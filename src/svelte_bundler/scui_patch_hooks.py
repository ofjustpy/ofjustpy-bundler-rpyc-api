...
def list_shadcn_components_in_module(mod_name,
    ...
    with patch('shadcnui_components.Alert', new=ShadcnWrapper(shadcnui_components.components.Alert)), \
         ...
         patch('shadcnui_components.AspectRatio', new=ShadcnWrapper(shadcnui_components.AspectRatio)), \
    ...
    with patch('shadcnui_components.Separator', new=ShadcnWrapper(shadcnui_components.Separator)),\
